...
import JobDashboardCard from '../../components/Cards/JobDashboardCards'
import ApplicantDashboardCard from '../../components/Cards/ApplicatnDashboardCard'
...
const StatCard = ({
  ...
  color = "blue"
    ...
    const colorClasses = {
      ...
      orange: "from-blue-500 to-orange-600"
    }
              ...
              >
                <StatCard
                 ...
                 <StatCard 
                    ...
                    icon={Users}
                    trend={true}
                    trendValue={`${dashboardData?.counts?.totalHired || 0}%`}
                    color='green'
                 />
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {quickActions.map((action, index) => (
          <button
            key={index}
            className="flex items-center space-x-3 p-4 rounded-xl border border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-colors"
